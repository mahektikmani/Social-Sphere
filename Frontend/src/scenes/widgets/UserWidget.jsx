...
const UserWidget = ({ userId, picturePath }) => {
    ...
    const getUser = async () => {
        const response = await fetch(`https://connect-c6ou.onrender.com/users/${userId}`, {
            method: "GET",
    ...
    // This means when we enter this page, getUser() will be called 
    useEffect(() => {
        getUser();
    ...
    // If user does not exist then it will return an error 
